...
export default function CustomerLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div style={{
      ...
      {/* 전화번호 띠 높이만큼 콘텐츠 밀어내기 */}
      <div style={{ paddingTop: showPhoneBar ? PHONE_BAR_H : 0 }}>
        {children}
      </div>
...
function NavBtn({
  ...
  return (
    ...
    >
      ...
      {active && (
        <span style={{ width: 4, height: 4, borderRadius: '50%', background: '#2563EB', marginTop: -2 }} />
      )}
    </button>
  );
}