    ...
    <div style={{ background: "#F9FAFB", minHeight: "100vh", fontFamily: "'Pretendard','Apple SD Gothic Neo',sans-serif" }}>
      <div style={{ maxWidth: 430, margin: "0 auto", paddingBottom: 60 }}>
        ...
        <div style={{ background: "#fff", borderBottom: "1px solid #E5E7EB", position: "sticky", top: 0, zIndex: 50, display: "flex", alignItems: "center", padding: "16px" }}>
          <button onClick={() => router.push('/')} style={{ padding: 4, background: "none", border: "none", cursor: "pointer", marginRight: 12 }}>
        ...
        <div style={{ padding: "24px 20px", display: "flex", flexDirection: "column", gap: 24 }}>
          ...
          <div>
            ...
            <p style={{ fontSize: 12, color: "#9CA3AF" }}>시행일: 2026년 5월 11일</p>
          </div>
          ...
          <div style={{ background: "#EFF6FF", border: "1px solid #BFDBFE", borderRadius: 12, padding: "16px 18px" }}>
            ...
            <ul style={{ paddingLeft: 18, display: "flex", flexDirection: "column", gap: 6, fontSize: 12, color: "#374151", lineHeight: 1.7 }}>
              <li><strong>수집 항목</strong>: 회사명, 담당자 성명, 휴대전화, 이메일</li>
              <li><strong>이용 목적</strong>: 보관 서비스 예약·관리, 결제·증빙, 안내 발송</li>
              <li><strong>보유 기간</strong>: 관계 법령에 따라 최대 5년</li>
              <li><strong>제3자 제공</strong>: 원칙적으로 제공하지 않음</li>
              <li><strong>처리 위탁 및 국외 이전</strong>: 결제·데이터 저장·메일/알림 발송 업무 위탁(아래 참조)</li>
            </ul>
          ...
          <Section title="1. 개인정보의 수집 및 이용 목적">
            ...
            <ul style={{ paddingLeft: 20, display: "flex", flexDirection: "column", gap: 8 }}>
              <li><strong>보관 서비스 예약</strong>, 화물 입/출고 관리, 고객 상담 및 클레임 대응</li>
              <li>서비스 이용 <strong>요금 결제</strong>, 청구서 및 세금계산서 발급</li>
              <li>서비스 변경 사항, 긴급 공지 등 <strong>안내 메시지(카카오 알림톡, 이메일 등) 발송</strong></li>
            </ul>
          </Section>
          ...
          <Section title="2. 수집하는 개인정보 항목">
            ...
            <ul style={{ paddingLeft: 20, display: "flex", flexDirection: "column", gap: 8 }}>
              ...
              <li><strong>결제 관련 항목:</strong> 결제 및 정산 정보. 단, 카드번호 등 결제수단 정보는 결제대행사(PG사) 페이지에서 처리되며 <strong>회사가 직접 저장하지 않습니다.</strong></li>
              <li><strong>세금계산서 발행 시:</strong> 사업자등록증 사본, 담당자 성명·연락처·이메일</li>
          ...
          <Section title="4. 개인정보 처리의 위탁">
            <p style={{ marginBottom: 10 }}>회사는 원활한 서비스 제공을 위해 아래와 같이 개인정보 처리 업무를 위탁하고 있으며, 위탁 시 관계 법령에 따라 안전하게 관리될 수 있도록 필요한 사항을 규정하고 있습니다.</p>
            <ul style={{ paddingLeft: 20, display: "flex", flexDirection: "column", gap: 8 }}>
              <li><strong>PortOne(포트원) · NHN KCP:</strong> 결제 처리 및 결제 정보 검증</li>
              <li><strong>Supabase:</strong> 서비스 데이터 저장 및 관리(클라우드 인프라)</li>
              <li><strong>Resend:</strong> 안내·인증 이메일 발송</li>
              <li><strong>카카오:</strong> 카카오 로그인 및 카카오 채널을 통한 고객 상담</li>
              <li><strong>솔라피(Solapi) · 카카오:</strong> 카카오 알림톡 등 알림 메시지 발송</li>
            </ul>
          </Section>
          ...
          <Section title="5. 개인정보의 국외 이전">
            ...
            <ul style={{ paddingLeft: 20, display: "flex", flexDirection: "column", gap: 8 }}>
              <li><strong>Supabase Inc.:</strong> 회원·계약 데이터 저장 / 이전 시점: 서비스 이용 시 / 보유 기간: 위 보유기간과 동일</li>
              <li><strong>Resend Inc.:</strong> 이메일 주소 / 이메일 발송 시 / 발송 처리 후 지체 없이 파기</li>
          ...
          <Section title="8. 개인정보의 안전성 확보 조치">
            <p style={{ marginBottom: 10 }}>회사는 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.</p>
            <ul style={{ paddingLeft: 20, display: "flex", flexDirection: "column", gap: 8 }}>
              <li><strong>관리적 조치:</strong> 개인정보 취급 담당자 최소화 및 접근 권한 관리</li>
              <li><strong>기술적 조치:</strong> 개인정보 처리시스템 접근 권한 관리, 데이터 전송 구간 암호화(SSL)</li>
            </ul>
          </Section>
          ...
          <Section title="11. 개인정보 처리방침의 변경">
            이 개인정보 처리방침은 시행일로부터 적용되며, 법령 및 방침에 따른 변경 내용의 추가, 삭제 및 정정이 있는 경우에는 변경사항의 시행 전부터 공지사항을 통하여 고지할 것입니다.
          </Section>
