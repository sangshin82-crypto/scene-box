      ...
      <div style={{ maxWidth: 430, margin: "0 auto", paddingBottom: 60 }}>
        ...
        <div style={{ padding: "24px 20px", display: "flex", flexDirection: "column", gap: 24 }}>
          ...
          <Section title="제2조 (이용 요금 및 결제)">
            <ol style={{ paddingLeft: 20, display: "flex", flexDirection: "column", gap: 8 }}>
              <li>보관 요금은 <strong>롤테이너 1칸(가로 1.1m × 세로 0.8m × 높이 1.5m, 약 1,300리터)당 월 44,000원</strong>이며, 3개월 약정 시 프로모션가 <strong>월 33,000원</strong>이 적용됩니다. (표시 요금은 부가가치세가 포함된 금액입니다.)</li>
          ...
          <Section title="제4조 (반출)">
            ...
            <ol style={{ paddingLeft: 20, display: "flex", flexDirection: "column", gap: 8 }}>
              <li><strong>정기 반출(무료):</strong> 약정 기간을 정상 이행한 후 보관을 종료하며 전체 물품을 반출하는 방식으로, 무료로 제공됩니다. 정기 반출로 전체 물품을 반출할 경우 <strong>보관 계약이 종료</strong>됩니다.</li>
