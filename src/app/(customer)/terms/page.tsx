        ...
        <div style={{ padding: "24px 20px", display: "flex", flexDirection: "column", gap: 24 }}>
          ...
          <Section title="제1조 (목적 및 서비스의 성격)">
            <ol style={{ paddingLeft: 20, display: "flex", flexDirection: "column", gap: 8 }}>
              ...
              <li>회사가 제공하는 서비스는 화물의 보존 및 관리를 전적으로 책임지는 '수치인'으로서의 보관업이 아니며, 고객의 물품을 적재할 수 있는 <strong>'물리적 공간(마당 및 컨테이너 Grid)을 제공하는 공간 임대업'</strong>에 한정됩니다.</li>
            </ol>
          </Section>

          <Section title="제2조 (보관 불가 품목)">
            <p style={{ marginBottom: 10 }}>회사는 창고의 안전과 다른 고객의 화물 보호를 위해 다음 각 호의 물품에 대해 보관을 거절할 수 있으며, 고객이 이를 은폐하고 입고하여 당사 시설이나 타 고객에게 발생한 모든 직/간접적 피해는 해당 고객이 100% 변상해야 합니다.</p>
            <ol style={{ paddingLeft: 20, display: "flex", flexDirection: "column", gap: 8 }}>
          ...
          <Section title="제4조 (고객의 자체 보험 가입 의무)">
            <ol style={{ paddingLeft: 20, display: "flex", flexDirection: "column", gap: 8 }}>
              ...
              <li>고객은 입고하는 모든 자산에 대하여 <strong>고객 측의 비용과 책임으로 '제작 보험' 또는 '자체 자산 종합 보험'에 가입한 후 입고</strong>해야 하며, 미가입 시 발생하는 모든 손해는 회사가 배상하지 않습니다.</li>
            </ol>
          </Section>

          <Section title="제5조 (초강력 면책 조항 및 손해배상 청구 불가)">
            <p style={{ marginBottom: 10 }}>회사는 다음 각 호의 사유로 발생한 화물의 멸실, 훼손, 파손에 대해 민·형사상 일체의 배상 책임을 지지 않으며, 고객은 회사에 손해배상을 청구할 수 없습니다.</p>
            <ol style={{ paddingLeft: 20, display: "flex", flexDirection: "column", gap: 8 }}>
              <li><strong>특수 환경 동의:</strong> 야외 마당 및 컨테이너 보관 환경의 특성(우천, 폭설, 결로, 습도 및 온도 변화)으로 인한 자연적인 훼손, 곰팡이, 부식, 변색 등</li>
              <li><strong>불가항력적 사고:</strong> 해충 및 조수해(쥐 등), 원인을 알 수 없는 화재, 도난, 외부 침입자에 의한 파손</li>
              <li><strong>운송 과실:</strong> 고객이 섭외한 탁송 기사의 상하차 과정에서 발생한 파손 및 출고 인계 이후 발생한 손해</li>
              <li>고객의 포장 불량이나 화물 자체의 자연적인 결함으로 인한 손해</li>
            </ol>
          </Section>

          <Section title="제6조 (요금 결제 및 연체 화물의 임의 처분)">
            <ol style={{ paddingLeft: 20, display: "flex", flexDirection: "column", gap: 8 }}>
              <li>서비스 이용 요금은 선결제를 원칙으로 합니다.</li>
              <li>보관 기간이 종료되었음에도 <strong>요금이 60일 이상 장기 연체될 경우</strong>, 회사는 사전 최고 후 공간 확보를 위해 해당 화물을 임의로 반출, 매각, 또는 폐기 처분할 수 있습니다.</li>
            </ol>
          </Section>
