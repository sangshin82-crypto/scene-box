  ...
  return (
    <>
      <style>{`
        ...
        .lp .hero-stage {
          width: 100%; background: #FDD706; padding-top: 213px;
        }
        .lp .hero-bottom {
        ...
        .lp .hero-sub {
          ...
          color: ${BLUE_DEEP}; text-align: center; line-height: 1.9; max-width: 500px;
          opacity: 0; animation: lpFadeUp 0.8s ease 0.8s forwards; z-index: 2;
        }
        .lp .hero-cta {
          margin-top: 44px; display: flex; gap: 16px; justify-content: center;
        ...
        .lp .howto-tag { font-family: 'Archivo', sans-serif; font-size: 12px; font-weight: 800; letter-spacing: 1.5px; margin-bottom: 18px; }
        .lp .howto-a .howto-tag { color: ${YELLOW}; }
        .lp .howto-b .howto-tag { color: #D2691E; }
        ...
        @media (max-width: 880px) {
          ...
          .lp .hero-stage { padding-top: 122px; }
